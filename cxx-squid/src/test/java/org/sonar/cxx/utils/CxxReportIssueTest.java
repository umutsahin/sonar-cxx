...
public class CxxReportIssueTest {
  ...
  public void reportLocationEquality() {
    CxxReportLocation location0 = new CxxReportLocation("path0.cpp", "1", null, "Boolean value assigned to pointer.");
    CxxReportLocation location1 = new CxxReportLocation("path0.cpp", "1", null, "Boolean value assigned to pointer.");
    assertEquals(location0, location1);
    assertEquals(location0.hashCode(), location1.hashCode());

    CxxReportLocation location2 = new CxxReportLocation("path2.cpp", "1", null, "Exception thrown in destructor.");
  ...
  public void reportIssueEquality() {
    CxxReportIssue issue0 = new CxxReportIssue("nullPointer", "path0.cpp", "1", null, "Null pointer dereference: ptr");
    issue0.addLocation("path0.cpp", "1", null, "Assignment &apos;ptr=nullptr&apos;, assigned value is 0");

    CxxReportIssue issue1 = new CxxReportIssue("exceptThrowInDestructor", "path2.cpp", "1", null, "Exception thrown in destructor.");
    CxxReportIssue issue2 = new CxxReportIssue("exceptThrowInDestructor", "path2.cpp", "1", null, "Exception thrown in destructor.");
  ...
  public void reportIssueEqualityConsideringFlow() {
    CxxReportIssue issue0 = new CxxReportIssue("exceptThrowInDestructor", "path2.cpp", "1", null, "Exception thrown in destructor.");
    ...
    CxxReportIssue issue3 = new CxxReportIssue("exceptThrowInDestructor", "path2.cpp", "1", null, "Exception thrown in destructor.");
